                        ...
                        <div class="dataTables_wrapper form-inline dt-bootstrap">
                            <div class="row">
                                ...
                                <div class="col-sm-4 float-right">
                                    <a class="btn btn-primary waves-effect float-right" onclick="showpopup();">@lang('lang.Add_Parent')</a>
                                </div>
                            </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>0786870058</td>
                                    <td class="students">
                                        <div class="col-sm-12">khalid</div>
                                        <div class="col-sm-12">hussam</div>
                                        <div class="col-sm-12">osaid</div>
                                    </td>
                                    <td>2011/04/25</td>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="dataTables_info" >
                                        ...
                                        <span class="pull-left">10 </span><span class="pull-left">@lang('lang.of')</span><span class="pull-left">57</span><span class="pull-left">@lang('lang.Parents')</span>
                                    </div>
                                </div>
                                <div class="col-sm-7">
