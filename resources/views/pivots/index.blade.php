                    ...
                    <div class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-4 float-right">
                                <a class="btn btn-primary waves-effect float-right btn-addPivots" onclick="showpopup();">@lang('lang.Add_Pivots')</a>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tr>
                                ...
                                <td>Domain</td>
                                <td class="action">
                                    <a onclick="showpopup();" class="btn-editPivots" title="@lang('lang.Edit')"><i class="material-icons">edit</i></a>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="dataTables_info">
                                    ...
                                    <span class="pull-left">10 </span><span class="pull-left">@lang('lang.of')</span><span class="pull-left">57</span><span class="pull-left">@lang('lang.Pivots')</span>
                                </div>
                            </div>
                            <div class="col-sm-7">
